    ...
    for(j in 1:length(phi)){
      ...
      for(i in 2:dim(x.R)[2]){
        ...
        x.R[1,i]<-Su*(1-beta*(x.R[2,i-1]/x.R[3,i-1]))*x.R[1,i-1]+
          ...
          Su*phi[j]*tmp.r*psi*(1-beta*(x.R[2,i-1]/x.R[3,i-1]))*x.R[2,i-1]
...
#3. Pathogen prevalence for survival-based regulation
#4. Pathogen prevalence for reproduction-based regulation
saveRDS(fRESULTS.N.S, paste0("MTfNS_",Su,".rds"))
saveRDS(fRESULTS.N.R, paste0("MTfNR_",Su,".rds"))
saveRDS(fRESULTS.PR.S, paste0("MTfPRS_",Su,".rds"))
saveRDS(fRESULTS.PR.R, paste0("MTfPRR_",Su,".rds"))
