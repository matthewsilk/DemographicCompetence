---
title: "SupMat_RIS_DDtransmission"
author: "Matthew Silk"
date: "21/01/2020"
    ...
    for(j in 1:length(phi)){
      ...
      for(i in 2:dim(x.R)[2]){
          ...
          x.R[1,i]<-Su*(1-beta*(x.R[2,i-1]))*x.R[1,i-1]+
            ...
            Su*tmp.r*psi*(1-beta*(x.R[2,i-1]))*x.R[2,i-1]
          x.R[2,i]<-Su*phi[j]*beta*(x.R[2,i-1])*x.R[1,i-1]+
            Su*phi[j]*tmp.r*(beta*(x.R[2,i-1]))*x.R[1,i-1]+
            Su*phi[j]*x.R[2,i-1]+
          ...
          x.S[1,i]<-tmp.su*(1-beta*(x.S[2,i-1]))*x.S[1,i-1]+
            ...
            tmp.su*R*psi*(1-beta*(x.S[2,i-1]))*x.S[2,i-1]
          x.S[2,i]<-tmp.su*phi[j]*beta*(x.S[2,i-1])*x.S[1,i-1]+
            tmp.su*phi[j]*R*(beta*(x.S[2,i-1]))*x.S[1,i-1]+
...
#3. Pathogen prevalence for survival-based regulation
#4. Pathogen prevalence for reproduction-based regulation
saveRDS(dRESULTS.N.S,paste0("RISdNS_",Su,".rds"))
saveRDS(dRESULTS.N.R,paste0("RISdNR_",Su,".rds"))
saveRDS(dRESULTS.PR.S,paste0("RISdPRS_",Su,".rds"))
saveRDS(dRESULTS.PR.R,paste0("RISdPRR_",Su,".rds"))
