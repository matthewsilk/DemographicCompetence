---
title: "SupMat_RSI_DDtransmission"
author: "Matthew Silk"
date: "21/01/2020"
    ...
    for(j in 1:length(phi)){
      ...
      for(i in 2:dim(x.R)[2]){
          ...
          x.R[2,i]<-Su*beta*(x.R[2,i-1])*x.R[1,i-1]+
            ...
            Su*phi[j]*x.R[2,i-1]+
            Su*tmp.r*psi*(beta*(x.R[2,i-1]))*x.R[2,i-1]
          ...
          x.S[2,i]<-tmp.su*beta*(x.S[2,i-1])*x.S[1,i-1]+
            ...
            tmp.su*R*psi*(beta*(x.S[2,i-1]))*x.S[2,i-1]
...
#3. Pathogen prevalence for survival-based regulation
#4. Pathogen prevalence for reproduction-based regulation
saveRDS(dRESULTS.N.S,paste0("RSIdNS_",Su,".rds"))
saveRDS(dRESULTS.N.R,paste0("RSIdNR_",Su,".rds"))
saveRDS(dRESULTS.PR.S,paste0("RSIdPRS_",Su,".rds"))
saveRDS(dRESULTS.PR.R,paste0("RSIdPRR_",Su,".rds"))
