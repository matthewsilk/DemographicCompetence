  ...
  for(jj in 1:length(betas)){
    ...
    for(j in 1:length(phi)){
      ...
      for(i in 2:dim(x.R)[2]){
        ...
        x.R[1,i]<-Su*tmp.r*(1-beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[3,i-1]+
                  Su*phi[j]*tmp.r*psi*(1-beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[4,i-1]
        x.R[2,i]<-Su*tmp.r*(beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[3,i-1]+
                  Su*phi[j]*tmp.r*psi*(beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[4,i-1]
        x.R[3,i]<-Su*JSu*(1-beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[1,i-1]+
                  Su*(1-beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[3,i-1]
        x.R[4,i]<-Su*JSu*(beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[1,i-1]+
                  Su*(beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[3,i-1]+
                  Su*JSu*phi[j]*x.R[2,i-1]+
                  Su*phi[j]*x.R[4,i-1]
        x.R[5,i]<-sum(x.R[1:4,i])
        
        #Host DD survival model
        x.S[1,i]<-tmp.su*R*(1-beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[3,i-1]+
                  tmp.su*phi[j]*R*psi*(1-beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[4,i-1]
        x.S[2,i]<-Su*tmp.r*(beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[3,i-1]+
                  Su*phi[j]*tmp.r*psi*(beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[4,i-1]
        x.S[3,i]<-tmp.su*JSu*(1-beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[1,i-1]+
                  tmp.su*(1-beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[3,i-1]
        x.S[4,i]<-tmp.su*JSu*(beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[1,i-1]+
                  tmp.su*(beta*((x.R[2,i-1]+x.R[4,i-1])/x.R[5,i-1]))*x.R[3,i-1]+
        ...
        if(i>1000){if(sd(x.R[5,(i-999):i])==0&sd(x.S[5,(i-999):i])==0){break()}}
        
      } #end loop over timesteps
      
      #Store results
      prev.R[j]<-(x.R[2,i]+x.R[4,i])/x.R[5,i]
      prev.S[j]<-(x.S[2,i]+x.S[4,i])/x.S[5,i]
      N.R[j]<-x.R[5,i]
      N.S[j]<-x.S[5,i]
...
#3. Pathogen prevalence for survival-based regulation
#4. Pathogen prevalence for reproduction-based regulation
saveRDS(fRESULTS.N.S,paste0("ASfNS_",JSu,"_",Su,".rds"))
saveRDS(fRESULTS.N.R,paste0("ASfNR_",JSu,"_",Su,".rds"))
saveRDS(fRESULTS.PR.S,paste0("ASfPRS_",JSu,"_",Su,".rds"))
saveRDS(fRESULTS.PR.R,paste0("ASfPRR_",JSu,"_",Su,".rds"))
